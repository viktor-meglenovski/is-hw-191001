    ...
    public partial class initialOnion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectionOrder", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectionShoppingCarts", x => new { x.ProjectionId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_ProjectionShoppingCarts_Projections_ProjectionId",
                        column: x => x.ProjectionId,
                        principalTable: "Projections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectionShoppingCarts_ShoppingCarts_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectionShoppingCarts_ShoppingCartId",
                table: "ProjectionShoppingCarts",
